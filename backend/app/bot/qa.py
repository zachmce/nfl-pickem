...
CLASSIFIER_SYSTEM_PROMPT = (
    ...
    "(recent ESPN headlines about a specific team or the league; a team's roster moves "
    "or its playoff chances are open_nfl, NOT news), "
    ...
    "or a division's win-loss record, a team's playoff chances or projections, roster "
    "moves such as signings, releases and trades, award winners, team or "
