...
bots + oracle, run as a single weeks-1-3 walkthrough of the 2025 season against
the REAL app surfaces.

For each week N (default 1, 2, 3) the driver:
...
# Default per-week set for the walkthrough.
DEFAULT_WEEKS: tuple[int, ...] = (1, 2, 3)
